app.controller('PageCtrl', function($scope, Page, $stateParams, Bookmark, $window, $rootScope, $timeout, $anchorScroll, $location, User, serverUrl){
  ...
  // Socket
  var socket = $window.io(serverUrl);
